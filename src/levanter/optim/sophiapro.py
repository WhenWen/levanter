...
class ScaleBySophiaProState(NamedTuple):
    """State for SophiaPro and similar."""
...
# @runtime_checkable
# class SophiaProGObjective(typing.Protocol):
#     """
#     Class for objective functions that can be used with SophiaPro-G
#
#     SophiaPro-G is a second order optimizer that uses the Gauss-Newton-Bartlett approximation to the Hessian
...
#
#         By default, we just return 1, and you can just pull the term into the hyperparams of SophiaPro if you want.
#
#         Returns:
...
#
#
#     def apply_partial(self, *args, **kwargs) -> "SophiaProGObjective":
#         """
...
#
#
# class PartialSophiaProG(SophiaProGObjective):
#     def __init__(self, objective: SophiaProGObjective, *args, **kwargs):
...
#
#    def apply_partial(self, *args, **kwargs) -> SophiaProGObjective:
#        return PartialSophiaProG(self.objective, *self.args, *args, **self.kwargs, **kwargs)

@dataclass
class BaseSophiaProConfig(HessianOptConfig):
    ...
    def build(self, num_train_steps: int):
        def _optimizer(learning_rate) -> optax.GradientTransformation:
            ...
            gamma = learning_rate * self.lr_2_gamma_ratio
        ...
        self.lr_2_gamma_ratio = self.gamma / self.learning_rate  # type: ignore
...
# @dataclass
# class SophiaProGConfig(BaseSophiaProConfig):
...
@OptimizerConfig.register_subclass("sophiapro-h")
@dataclass
class SophiaProHConfig(BaseSophiaProConfig):
...
def sophia_h(
    ...
    *,
    ...
    """SophiaPro-H: https://arxiv.org/pdf/2305.14342.pdf Algorithm 1&3"""
    components = []
...
def sophia_g(
    ...
    *,
    ...
    """SophiaPro-G: https://arxiv.org/pdf/2305.14342.pdf Algorithm 2&3"""
    components = []
...
def stochastic_diag_gauss_newton(fn, model, *args, hess_key: PRNGKey, **kwargs):
    ...
    Args:
        fn (SophiaProGObjective): objective function
        model: model whose Hessian to compute
        hess_key: key for sampling
        *args, **kwargs: passed to fn's logits
    """
    raise NotImplementedError("This is not implemented yet")
    # if not isinstance(fn, SophiaProGObjective):
    #     raise ValueError("objective must be a SophiaProGObjective")
